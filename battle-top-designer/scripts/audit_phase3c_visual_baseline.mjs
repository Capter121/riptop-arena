...
const outputArgument = outputIndex === -1 ? 'reports/validation/phase3c-a-input-inventory.json' : process.argv[outputIndex + 1];
if (!outputArgument || outputArgument.startsWith('--')) throw new Error('Expected a report path after --output');
